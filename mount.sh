...
if [ "$ACTION" = "add" ] && [ -n "$DEVNAME" ]; then
    ...
    # 20111012: http://www.diag.com/navigation/downloads/Biscuit mailto:coverclock@diag.com
	[ -x /usr/local/bin/biscuit -a -d /media/$name ] && ( cd /media/$name; exec /usr/local/bin/biscuit )
fi
